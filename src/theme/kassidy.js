...
/**
 * kassidy theme — built by `npx astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { kassidyTheme } from './kassidy';
 *   import './kassidy.css';
 */
export const kassidyTheme = {
  name: 'kassidy',
  __built: true,
  tokens: {
    ...
    "--color-accent": "light-dark(#4e5848, #c5cfb8)",
    "--color-accent-muted": "light-dark(#25252a14, #f3f3f520)",
    "--color-neutral": "light-dark(#25252a0f, #f3f3f51a)",
    "--color-background-surface": "light-dark(#f4f1eb, #20201e)",
    "--color-background-body": "light-dark(#f4f1eb, #20201e)",
    ...
    "--color-background-muted": "light-dark(#e9e5dc, #34332f)",
    "--color-text-primary": "light-dark(#292b27, #f4f1eb)",
    "--color-text-secondary": "light-dark(#62635a, #c3c1b8)",
    "--color-text-disabled": "light-dark(#d7d7da, #5e5e61)",
    "--color-text-accent": "light-dark(#4e5848, #c5cfb8)",
    ...
    "--color-background-inverted": "light-dark(#292b27, #e9e5dc)",
    ...
    "--color-border": "light-dark(#d6d2c8, #52534b)",
